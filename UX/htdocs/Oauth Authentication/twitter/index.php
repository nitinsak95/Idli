...
define('CONSUMER_KEY', 'VR3He3nmXow0RvmQLZxUA14i0');
define('CONSUMER_SECRET', 'VQtALSl2pkeYBY2lgPD8isPGYPulfNDfKoTjxPpS7teZy6ZJF7');
define('OAUTH_CALLBACK', 'http://127.0.0.1/twlogin');
// start the session
session_start();
